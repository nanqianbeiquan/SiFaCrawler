...
public class SifaParserKafka {
	
	public double maxmoney=0;
	public String namestr=null;
	public String personstr=null;
	public String panjuestr=null;
	public String content=null;
	public String losingParty=null;
	public String litigationType=null;
	public String instrumentType=null;
	public String documentType=null;
	public String relatedAmountstr=null;
	 ...
	 * @throws SQLException
	 */
	public void caseType(String documentType) throws IOException, ClassNotFoundException, SQLException
	{
	 ...
	 * @throws SQLException
	 */
	public void litigant(String doc,String legalParties) throws IOException, ClassNotFoundException, SQLException
	{		
...
//			System.out.println("PersonSex:"+PersonSex);
	 ...
	 * @param dsrmz
	 */
	public void brith(String dsrmz)
	{
...
//			System.out.println("PersonBirthday:"+PersonBirthday);
	 ...
	 * @param dsrmz
	 */
	public void number(String dsrmz)
	{		
...
//				System.out.println("PersonCard:"+PersonCard);
	 ...
	 * @param dsrmz
	 */
	public void address(String dsrmz)
	{
...
//			System.out.println("PersonAddress:"+PersonAddress);
	 ...
	 * @param dsrmz
	 */
	public void office(String dsrmz)
	{
...
//				System.out.println("PersonOffice:"+PersonOffice);
	 ...
	 * @throws SQLException
	 */
	public void company(String PersonName,String PersonIdentity)throws IOException,ClassNotFoundException,SQLException
	{
//		System.out.println("PersonName:"+PersonName);
...
//    		System.out.println(insertCom);
    		...
    		jsonObj2.put("companyname", PersonName);
    		jsonObj2.put("shuxing", PersonIdentity);
    		jsonObj2.put("rowkey", PersonName+"_20_"+docId);
    		resArr.add(jsonObj2);
//    		jsonObj2.putAll(jsonObj1);
        }
	}
	 ...
	 * @param doc 文书全文
	 */
	public void judgecontent(String doc)
	{
//		int gaiyao=0;
...
//		判决结束位置		
	 ...
	 */
	public void RelatedAmount(String panjuestr)
	{
...
//			System.out.println(stack);
     ...
     * @param namestr 当事人列表
     */
    public void losingParty(String panjuestr,String namestr)
    {
...
//			System.out.println("loseList:"+loseList);
	...
	public JSONArray parse(String doc,String id,String dangshiren) throws ClassNotFoundException, IOException, SQLException
	{	
		maxmoney=0;
		namestr=null;
		personstr=null;
...
//				System.out.println(insertCmd2);
				...
				jsonObj1.put("casetype",documentType);
				jsonObj1.put("litigationtype", litigationType);
//				jsonObj1.put("trialclass", null);
				jsonObj1.put("instrumenttype", instrumentType);
				jsonObj1.put("amountcount", maxmoney);
				jsonObj1.put("relatedperson", personstr);
				jsonObj1.put("relatedamount", relatedAmountstr);
				jsonObj1.put("judgmentresult", panjuestr);
				jsonObj1.put("content", content);
				jsonObj1.put("loser", losingParty);
				jsonObj1.put("personnamelist", namestr);
				jsonObj1.put("docid", docId);
				jsonObj1.put("astmodifytime",TimeUtils.getNow());
				for(int i=0;i<resArr.size();i++)
				{
					resArr.getJSONObject(i).putAll(jsonObj1);
				}
...
//		System.out.println(c);
		...
		parser.parse(c, "21f8de53-9f59-42c2-9bcb-a224bb7ac589", "山起重型机械股份公司,东营市东辰节能电力设备有限公司");
	}
}
